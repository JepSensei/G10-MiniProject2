function getBotResponse(input) {
    ...
    if (input == "hello") {
        ...
        return "Keywords/Commands: <br/><br/> <strong>menu</strong> - it will show our menu. <br/> <strong>about</strong> - it will show the 'about us'. <br/> <strong>contact</strong>- it will show 'contact info'. <br/> <strong>location</strong> - it will show our address <strong>commands</strong> - it will show 'keyword'. <br/> ";
    } else if (input == "menu") {
